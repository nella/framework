...
class ClassMetadataTest extends \Nella\Testing\TestCase
{
	...
	{
		$this->metadata = new \Nella\Validator\ClassMetadata('NellaTests\Validator\ClassMetadata\Bar');
	}
	...
	{
		$this->assertEquals('NellaTests\Validator\ClassMetadata\Bar', $this->metadata->getName(),
			"->getName() equals metadata class name");
		$this->assertEquals('NellaTests\Validator\ClassMetadata\Bar', $this->metadata->name,
			"->name equals metadata class name");
	}

	public function testGetParent()
	{
		$this->assertEquals('NellaTests\Validator\ClassMetadata\Foo', $this->metadata->getParent(),
			"->getParent() equals metadata parent class name");
		$this->assertEquals('NellaTests\Validator\ClassMetadata\Foo', $this->metadata->parent,
			"->parent equals metadata parent class name");
	}

	public function testGetParentWithoutParent()
	{
		$this->metadata = new \Nella\Validator\ClassMetadata('NellaTests\Validator\ClassMetadata\Foo');
...
namespace NellaTests\Validator\ClassMetadata;
