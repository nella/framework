...
namespace NellaTests\Model\Config;

use Nella\Model\Config\Extension;
...
class ExtensionTest extends \Nella\Testing\TestCase
{
	public function testRegister()
	{
		...
		$this->assertInstanceOf('Nella\Model\Config\Extension', $compiler->extensions[Extension::DEFAULT_EXTENSION_NAME]);
	}
}
