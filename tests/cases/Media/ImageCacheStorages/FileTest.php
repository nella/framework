...
namespace NellaTests\Media\ImageCacheStorages;

use Nella\Media\ImageCacheStorages\File,
	Nette\Caching\Cache;
...
class FileTest extends \Nella\Testing\TestCase
{
	...
	{
		$this->assertInstanceOf('Nella\Media\IImageCacheStorage', $this->storage, 'is Nella\Media\IImageCacheStorage');
	}
