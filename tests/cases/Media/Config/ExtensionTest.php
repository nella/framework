...
namespace NellaTests\Media\Config;

use Nella\Media\Config\Extension;
...
class ExtensionTest extends \Nella\Testing\TestCase
{
	public function testRegister()
	{
		...
		$this->assertInstanceOf('Nella\Media\Config\Extension', $compiler->extensions[Extension::DEFAULT_EXTENSION_NAME]);
	}
}
