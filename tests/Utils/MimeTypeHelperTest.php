...
namespace NellaTests\Utils;

require_once __DIR__ . "/../bootstrap.php";

use Nella\Utils\MimeTypeHelper;

class MimeTypeHelperTest extends \Nella\Testing\TestCase
{
	private $map = array(
	...
	public function dataExtToMime()
	{
		...
		$data = array();
		foreach ($this->map as $ext) {
			$data[] = array($ext, $map[$ext]);
		}
		return $data;
	}
	...
	{
		$this->assertEquals($mime, MimeTypeHelper::extToMime($ext), "::extToMime('$ext')");
	}
	
	public function dataMimeToExt()
	{
		$data = array();
		foreach ($this->map as $mime => $ext) {
			$data[] = array($mime, $ext);
		}
		return $data;
	}
	...
	{
		$this->assertEquals($ext, MimeTypeHelper::mimeToExt($mime), "::mimeToExt('$mime')");
	}
}