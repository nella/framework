...
{
	/** @var Nella\Models\Listeners\Timestampable */
	private $listener;

	public function setUp()
	{
		$this->listener = new \Nella\Models\Listeners\Timestampable;
	}
	...
	public function testTimestampable()
	{
		...
		$args = new \Doctrine\ORM\Event\LoadClassMetadataEventArgs($em->getClassMetadata('NellaTests\Models\Listeners\TimestampableEntityMock'), $em);
