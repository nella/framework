...
class UserableListenerTest extends \PHPUnit_Framework_TestCase
{
	/** @var \Nella\Security\IdentiyEntity */
	/** @var \Nella\Models\UserableListener */
	private $listener;
	...
	public function setUp()
	{
		...
		$this->listener = new \Nella\Models\UserableListener($identity);
	}
