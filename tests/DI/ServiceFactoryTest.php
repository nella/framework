...
class ServiceFactoryTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		parent::setUp();
		$this->factory = new ServiceFactoryMock(new \Nella\DI\Context, 'foo');
	}

	public function testSettersAndGetters()
	{
		$this->assertInstanceOf('Nella\DI\IContext', $this->factory->context,
			"->context equals IContext instance"
		);

		$this->assertEquals("foo", $this->factory->name, "->name equals 'foo'");

		$this->factory->class = 'NellaTests\DI\Foo';
		$this->assertEquals('NellaTests\DI\Foo', $this->factory->class,
		...
		$this->factory->factory = 'NellaTests\DI\Foo::create';
	...
	{
		$this->factory->setClass('NellaTests\DI\Foo');
		$this->assertInstanceOf('NellaTests\DI\Foo', $this->factory->createInstanceMock());
	}
	...
	public function testGetInstance()
	{
		...
		$this->assertInstanceOf('NellaTests\DI\Foo', $instance,
			"->getInstance() is instance of test object"
		);

		$this->assertInstanceOf('NellaTests\DI\Foo', $instance->bar,
