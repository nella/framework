...
class ImageFormatTest extends \Nella\Testing\TestCase
{
	...
	{
		$this->assertInstanceOf('Nella\Media\IImageFormat', $this->format);
	}
	...
	public function testWatermark()
	{
		...
		$this->assertInstanceOf('Nella\Media\IImage', $this->format->getWatermark(), 'insatnce of Nella\Media\IImage');
