...
class ControlTest extends \Nella\Testing\TestCase
{
	...
	public function dataFormatTemplateFiles()
	{
		...
		return array(
			array('render', array(
				$context->parameters['appDir'] . "/Application/UI/Control/templates/ControlMock.latte",
				$context->parameters['appDir'] . "/Application/UI/Control/templates/ControlMock/@global.latte",
				...
				__DIR__ . "/Application/UI/Control/templates/ControlMock.latte",
				__DIR__ . "/Application/UI/Control/templates/ControlMock/@global.latte",
				...
				$context->expand('%appDir%/Nella') . "/Application/UI/Control/templates/ControlMock.latte",
				$context->expand('%appDir%/Nella') . "/Application/UI/Control/templates/ControlMock/@global.latte",
			...
			array('renderTest', array(
				$context->parameters['appDir'] . "/Application/UI/Control/templates/ControlMock/test.latte",
				$context->parameters['appDir'] . "/Application/UI/Control/templates/ControlMock.test.latte",
				$context->parameters['appDir'] . "/Application/UI/Control/templates/ControlMock/@global.latte",
				...
				$context->parameters['appDir'] . "/Application/UI/Control/ControlMock/@global.latte",
				$context->parameters['appDir'] . "/Application/UI/Control/@global.latte",
				__DIR__ . "/Application/UI/Control/templates/ControlMock/test.latte",
				__DIR__ . "/Application/UI/Control/templates/ControlMock.test.latte",
				__DIR__ . "/Application/UI/Control/templates/ControlMock/@global.latte",
				...
				__DIR__ . "/Application/UI/Control/ControlMock/@global.latte",
				__DIR__ . "/Application/UI/Control/@global.latte",
				$context->expand('%appDir%/Nella') . "/Application/UI/Control/templates/ControlMock/test.latte",
				$context->expand('%appDir%/Nella') . "/Application/UI/Control/templates/ControlMock.test.latte",
				$context->expand('%appDir%/Nella') . "/Application/UI/Control/templates/ControlMock/@global.latte",
